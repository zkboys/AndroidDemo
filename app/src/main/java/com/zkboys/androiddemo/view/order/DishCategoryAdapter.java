...
public class DishCategoryAdapter extends RecyclerView.Adapter<DishCategoryAdapter.MyViewHolder> {
    ...
    public interface OnItemClickListener {
        void onClick(DishCategoryInfo categoryInfo, int position);
    }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onItemClickListener != null) {
                    ...
                    onItemClickListener.onClick(categoryInfo, position);
                }
            }
        });
        return holder;
    ...
    public int getCategoryPositionInPlainData(int position) {
        int posi = position;
